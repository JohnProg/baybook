...
import kotlinx.android.synthetic.main.fragment_register_optional.view.*
...
class RegisterOptionalFragment @SuppressLint("ValidFragment") private constructor() : Fragment(), TextWatcher {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, state: Bundle?): View? {
        ...
        mView.toolbar_register_optional.setNavigationOnClickListener { activity!!.onBackPressed() }
