...
class RoundedCornersTransformation @JvmOverloads constructor(
        private val mRadius: Float, private val mMargin: Int,
        private val mCornerType: CornerType = CornerType.ALL) : Transformation {

    private val mDiameter: Int = (mRadius * 2).toInt()
    ...
    private fun drawRoundRect(canvas: Canvas, paint: Paint, width: Float, height: Float) {
        ...
        when (mCornerType) {
            CornerType.ALL ->
                canvas.drawRoundRect(RectF(mMargin.toFloat(), mMargin.toFloat(), right, bottom), mRadius, mRadius, paint)
            CornerType.TOP_LEFT ->
    ...
    private fun drawTopLeftRoundRect(canvas: Canvas, paint: Paint, right: Float, bottom: Float) {
        ...
        canvas.drawRect(RectF(mMargin.toFloat(), (mMargin + mRadius), (mMargin + mRadius), bottom), paint)
    ...
    private fun drawDiagonalFromTopLeftRoundRect(canvas: Canvas, paint: Paint, right: Float,
        ...
        canvas.drawRoundRect(RectF(right - mDiameter, bottom - mDiameter, right, bottom), mRadius,
                mRadius, paint)
        canvas.drawRect(RectF(mMargin.toFloat(), (mMargin + mRadius), right - mDiameter, bottom), paint)
